...
def main():
    ...
    # Change the pre_train model name, data_name, path and target here
    ...
    # PcDB with data augmentation used
    # train_df = pd.read_csv("data/PcDB/PcDB_DA10_train.csv")
    # eval_df = pd.read_csv("data/PcDB/PcDB_DA10_eval.csv")
    # test_df = pd.read_csv("data/PcDB/PcDB_DA10_test.csv")
